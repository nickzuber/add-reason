...
function isReasonFile(str) {
  var pos = str.length;
  if (pos > 3) {
    return +($$String.sub(str, pos - 3 | 0, 3) === ".re");
  } else {
    return /* false */0;
  }
}

function safeExists(tbl, key) {
  try {
...
function deriveSourceDirectory(root) {
  Hashtbl.create(/* None */0, 42);
  var lst2 = Patches.test(root);
...
exports.isReasonFile          = isReasonFile;
exports.safeExists            = safeExists;
exports.printList             = printList;
exports.Path                  = Path$1;
exports.Fs                    = Fs$1;
exports.deriveSourceDirectory = deriveSourceDirectory;
