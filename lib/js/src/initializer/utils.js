...
function attemptToLink(position, source, dest) {
  ...
  var isValidPathDest = safeFileExists(removeTopFromPath(dest));
    ...
    console.log(Curry._4(Printf.sprintf(/* Format */[
                  /* String */Block.__(2, [
                      ...
                      /* String */Block.__(2, [
                          /* No_padding */0,
                          /* String_literal */Block.__(11, [
                              " Couldn't find your destination directory. Do you have a typo?\n",
                              /* String */Block.__(2, [
                                  /* No_padding */0,
                                  /* String */Block.__(2, [
                                      /* No_padding */0,
                  ...
                  "%s%s Couldn't find your destination directory. Do you have a typo?\n%s%s"
                ]), prefix, Chalk.red("failed"), GenericBindings$ReasonTemplate.altCodeDirectional, Chalk.bold(dest)));
    return /* false */0;
  }
}
