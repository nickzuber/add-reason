...
function performConfigCreation(position, _, _$1, rootDirectory) {
  ...
  return Utils$ReasonTemplate.Fs_Polyfill[/* attemptToCreateConfig */2](position, absolutePath, "// Generated by `add-reason init` command, feel free to edit this file!");
}
