...
function performConfigCreation(position, _, _$1, _$2) {
  ...
  console.log(Curry._3(Printf.sprintf(/* Format */[
              ...
              ]), position$1, GenericBindings$ReasonTemplate.getEmoji("page_with_curl"), Chalk.yellow("warning")));
  return /* true */1;
}
...
function performPostInstall(position, name, directory, _) {
  ...
  var postInstallCommand = Curry._2(Printf.sprintf(/* Format */[
                ...
                /* String */Block.__(2, [
                    ...
                    /* String_literal */Block.__(11, [
                        ...
                        /* String */Block.__(2, [
                            /* No_padding */0,
                            /* String_literal */Block.__(11, [
                                "',fs=require('fs');fs.exists(d,function(e){e||fs.symlinkSync(s,d,'dir')});",
                                /* End_of_format */0
                              ])
                          ])
                      ])
            ...
            "var s='%s',d='%s',fs=require('fs');fs.exists(d,function(e){e||fs.symlinkSync(s,d,'dir')});"
          ]), source, dest);
  console.log(Curry._3(Printf.sprintf(/* Format */[
                /* String */Block.__(2, [
                    /* No_padding */0,
                ...
                "%s %sAdding postinstall script... %s"
              ]), position$1, GenericBindings$ReasonTemplate.getEmoji("zap"), Chalk.yellow("warning")));
  console.log("--> " + postInstallCommand);
  return /* true */1;
}
