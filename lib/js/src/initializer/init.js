...
function attemptToLink(position, source, dest) {
  ...
  var targetDirectory = Utils$ReasonTemplate.Path[/* removeTopFromPath */2](dest);
  var existsSource = Utils$ReasonTemplate.FsPolyfill[/* safeFileExists */0](source);
  var existsDest = Utils$ReasonTemplate.FsPolyfill[/* safeFileExists */0](dest);
  var isValidPathDest = Utils$ReasonTemplate.FsPolyfill[/* safeFileExists */0](targetDirectory);
...
function attemptToCreateConfig(position, filename, contents) {
  try {
    ...
    var existsConfig = Utils$ReasonTemplate.FsPolyfill[/* safeFileExists */0](filename);
    if (existsConfig !== 0) {
      console.log(Curry._2(Printf.sprintf(/* Format */[
                    /* String */Block.__(2, [
                        /* No_padding */0,
...
function attemptToCreateMerlin(position, filename, contents) {
  try {
    ...
    var existsMerlin = Utils$ReasonTemplate.FsPolyfill[/* safeFileExists */0](filename);
    if (existsMerlin !== 0) {
      console.log(Curry._2(Printf.sprintf(/* Format */[
                    /* String */Block.__(2, [
                        /* No_padding */0,
...
function performLinking(position, name, directory, rootDirectory, isCancelled) {
  if (isCancelled) {
    var position$1 = Chalk.gray(Curry._2(Printf.sprintf(/* Format */[
                  /* Char_literal */Block.__(12, [
                      /* "[" */91,
    ...
    console.log(Curry._3(Printf.sprintf(/* Format */[
                  ...
                  "%s%sLinking package... %s"
                ]), position$1, GenericBindings$ReasonTemplate.getEmoji("link"), Chalk.red("cancelled")));
    return /* false */0;
  } else {
...
function performConfigCreation(position, _, directory, rootDirectory, isCancelled) {
  if (isCancelled) {
    var position$1 = Chalk.gray(Curry._2(Printf.sprintf(/* Format */[
                  /* Char_literal */Block.__(12, [
                      /* "[" */91,
    ...
    console.log(Curry._3(Printf.sprintf(/* Format */[
                ...
                ]), position$1, GenericBindings$ReasonTemplate.getEmoji("truck"), Chalk.red("cancelled")));
    return /* false */0;
  } else {
...
function performMerlinCreation(position, _, directory, rootDirectory, isCancelled) {
  if (isCancelled) {
    var position$1 = Chalk.gray(Curry._2(Printf.sprintf(/* Format */[
                  /* Char_literal */Block.__(12, [
                      /* "[" */91,
    ...
    console.log(Curry._3(Printf.sprintf(/* Format */[
                  ...
                  "%s%sCreating linter... %s"
                ]), position$1, GenericBindings$ReasonTemplate.getEmoji("lipstick"), Chalk.red("cancelled")));
    return /* false */0;
  } else {
    var absolutePath = Utils$ReasonTemplate.Path[/* combinePaths */1](/* None */0, /* :: */[
          rootDirectory,
...
function performEndpointSetup(position, _, directory, rootDirectory, isCancelled) {
  var position$1 = Chalk.gray(Curry._2(Printf.sprintf(/* Format */[
                /* Char_literal */Block.__(12, [
                    /* "[" */91,
                    /* Int */Block.__(4, [
  ...
  if (isCancelled !== 0) {
    console.log(Curry._3(Printf.sprintf(/* Format */[
                ...
                ]), position$1, GenericBindings$ReasonTemplate.getEmoji("open_file_folder"), Chalk.red("cancelled")));
    return /* false */0;
  } else if (existsDirectory !== 0) {
    if (existsLib !== 0) {
      if (existsLibJs !== 0) {
...
function performPostInstall(position, name, directory, rootDirectory, isCancelled) {
...
function execute(steps, name, directory, rootDirectory) {
  ...
  var loop = function (_steps, _index, _isCancelled) {
    while(true) {
      var isCancelled = _isCancelled;
      var index = _index;
      var steps = _steps;
      if (steps) {
        var rest = steps[1];
        var cur = steps[0];
        if (rest) {
          var success = Curry._5(cur, /* tuple */[
                index,
                total
              ], name, directory, rootDirectory, isCancelled);
          if (!success) {
            finishWithFailure[0] = /* true */1;
          }
          _isCancelled = finishWithFailure[0];
          _index = index + 1 | 0;
          _steps = rest;
          continue ;
          
        } else {
          var success$1 = Curry._5(cur, /* tuple */[
                index,
                total
              ], name, directory, rootDirectory, isCancelled);
          if (success$1) {
