...
function createBuildingConfig(inSource, _, source, root) {
  ...
  var contents = Patches.generateConfigContents(source, inSource, packagePath);
...
function main(source, root, version) {
  ...
  var stepsAsFunctions_000 = function (param, param$1, param$2) {
    return createBuildingConfig(/* false */0, param, param$1, param$2);
  };
  var stepsAsFunctions = /* :: */[
    stepsAsFunctions_000,
    /* [] */0
  ];
